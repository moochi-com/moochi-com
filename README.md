...
| リポジトリ | 内容 | 予定 |
|---|---|---|
| slm-medical-benchmark | SLMモデルの医療テキスト処理能力比較（Qwen/Phi/Gemma/ELYZA） | 6月 |
| medai-meeting-assistant | 医療会議支援ツール | 6月 |
| web-scraper-gui | ウェブスクレイパーGUI | 6月 |
| data-agent-skills | データエージェントスキル集 | 7月 |
...
<!-- ZENN -->
- **Zenn（技術向け）**: https://zenn.dev/nobby_chemist
...
*This repository and all related projects are personal activities, independent of my employer. All content is intended for educational and research purposes only.*
